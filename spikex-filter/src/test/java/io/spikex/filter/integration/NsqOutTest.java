...
import io.spikex.filter.output.Nsq;
 ...
 * @author cli
 */
public class NsqOutTest extends TestVerticle implements Handler<Long> {

    private int m_counter;
    private long m_timer;
    private static ChildProcess m_cmd;

    private static final String FILTER_NSQ_NAME = "Nsq.out";
    ...
    private static final Logger m_logger = LoggerFactory.getLogger(NsqOutTest.class);

    @Test
    public void testGenerateMessages() throws Exception {

        // This test requires on OS X: brew install openssl
    ...
    public void handle(final Long timerId) {
        if (m_counter++ > 50) {
            ...
            m_logger.info("Publishing batch: {}", m_counter);
